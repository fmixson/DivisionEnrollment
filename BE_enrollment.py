...
class DataframeWork:
    ...
    def lecture_only(self):
        ...
        if 'Summer' in self.semester:
            ...
            lecture_enrollment_df.to_csv('C:/Users/fmixson/Desktop/Dashboard_files/BE_Summer_Division_Enrollment.csv')
            lecture_enrollment_df.to_excel('BE_Summer_Division_Enrollment.xlsx')
        if 'Spring' in self.semester:
            lecture_enrollment_df.to_csv('C:/Users/fmixson/Desktop/Dashboard_files/BE_Spring_Division_Enrollment.csv')
            lecture_enrollment_df.to_csv('BE_Spring_Division_Enrollment.csv')
            lecture_enrollment_df.to_excel('BE_Spring_Division_Enrollment.xlsx')
        if 'Fall' in self.semester:
            lecture_enrollment_df.to_csv('C:/Users/fmixson/Desktop/Dashboard_files/BE_Fall_Division_Enrollment.csv')
            lecture_enrollment_df.to_csv('BE_Fall_Division_Enrollment.csv')
            lecture_enrollment_df.to_excel('BE_Fall_Division_Enrollment.xlsx')
        return
...
if 'Spring' in user_choice:
    ...
    # check_LA = driver.find_element(By.XPATH, '/html/body/form/table[6]/tbody/tr[5]/td[2]/label/input').click()
check_all = driver.find_element(By.XPATH, '/html/body/form/table[1]/tbody/tr[1]/td[1]/label/input').click()
check_BE = driver.find_element(By.XPATH, '/html/body/form/table[6]/tbody/tr[2]/td[1]/label').click()
click_View = driver.find_element(By.XPATH, '/html/body/form/p[4]/input').click()
page_loading = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.ID, 'RE130descs')))
